...
export const AnalysisResultsChat = () => {
  ...
  const startDateISOString = typeof rawStartDateISOString === "string"
    ? rawStartDateISOString
    : "";
  const endDateISOString = typeof rawEndDateISOString === "string"
    ? rawEndDateISOString
    : "";
  const analyzedUserId = typeof rawAnalyzedUserId === "string"
    ? rawAnalyzedUserId
    : "";
